<template>
	<div id="uppic">
		<!-- <slot></slot> -->
		<label class="avatar-label" for="my_avatar">识别入场</label>
		<input class="file" type="file" id="my_avatar" @change="getsrc"  capture='camera' ref="file">
		<div id="uppicBox" ref="uppicBox" v-show="isuppicBox">
			<div class="imageBox">
				...
				<div class="thumbBox box" :class="{'bgshadow':isbg}" ref="thumbBox" :style="{'width':Cwidth+'px','height':Cheight+'px','margin-left':0-Cwidth/2+'px','margin-top':0-Cheight/2+'px'}">
					...
					<div class="line3"></div>
					<div class="line4"></div>
					<p>· 框选范围能小则小</br>· 以提高识别速度</p>
				</div>
			</div>
			<div class="bottom" @click.stop>
				<span @click="cancel">取消</span>
				
				<span @click="clip" class="fr">立即识别</span>
			</div>
		</div>
	</div>
</template>
		...
		methods: {
			...
			drawPhoto: function(img, dir, next) {
				...
				image.onload = function() {
					var degree = 0,
						drawWidth, drawHeight, width, height, shuoxiao;
