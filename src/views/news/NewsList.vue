<template>
	<div>
		<div id="newslist" >
			<div class="news-box" v-for="(item,index) in newsDetail" :key="index" 
			     @click.stop="ToNews(item.newsId)">
					...
					<div class="news-content">
						...
						<div class="news-img">
							<van-image class="van-image" width=" 10rem" height=" 10rem" 
							           v-for="(i,k) in item.img" :key='k' :src="baseUrl+i"
